            ...
            <div class=" px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
                <div class=" mx-auto max-w-6xl text-center">
                    ...
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                        <a href="#"
                            class="bg-black px-10 py-3 text-sm font-semibold text-white shadow-sm hover:bg-indigo-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
                            Enquire
                        </a>
