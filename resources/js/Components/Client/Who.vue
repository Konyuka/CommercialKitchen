            ...
            <div class=" px-6 py-24 sm:px-6 sm:py-16 lg:px-8">
                <div class=" mx-auto max-w-6xl text-center">
                    ...
                    <p data-wow-duration="1s"
                        class="wow animate__lightSpeedInRight font-medium text-left mx-auto mt-6 max-w-6xl text-lg leading-8 text-white">
                    ...
                    <div data-wow-duration="1s" data-wow-delay="2s"
                        class="wow animate__backInUp mt-10 flex items-center justify-center gap-x-6">
                        <a href="#"
