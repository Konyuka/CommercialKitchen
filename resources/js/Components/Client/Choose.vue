            ...
            <div class="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
                <div
                    ...
                    <div class="lg:col-end-1 lg:w-full lg:max-w-3xl lg:pb-8">
                        ...
                        <p class="mt-6 text-xl leading-10 text-primary font-bold">We are a team that Cares!</p>
                        ...
                        <div class="mt-12 flex justify-between">
                            ...
                            <a href="tel:+254717269050" class="group transform transition hover:scale-95 duration-700 ease-out hover:cursor-pointer flex">
                                ...
                                <div class="ml-5">
                                    <div class="">
                                        <h1 class="font-bold text-2xl leading-10 text-primary">Get Expert Advice</h1>
                    ...
                    <div class="flex flex-wrap items-start justify-end gap-6 sm:gap-8 lg:contents">
                        <div class="w-0 flex-auto lg:ml-auto lg:w-auto lg:flex-none lg:self-end ">
                            <img src="https://images.unsplash.com/photo-1670272502246-768d249768ca?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1152&q=80"
                                alt=""
                                class="ring-4 ring-primary aspect-[7/5] w-[37rem] max-w-none rounded-2xl bg-gray-50 object-cover">
                        </div>
                        <!-- <div
