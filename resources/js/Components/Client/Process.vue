                ...
                <div class="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    ...
                    <div
                        ...
                        <p class="mt-6 flex items-baseline gap-x-1">
                            <span class="text-3xl font-bold tracking-tight text-white group-hover:text-primary">
                                Initial
                                Consultation
                            </span>
                        </p>
                    ...
                    <div
                        ...
                        <p class="mt-6 flex items-baseline gap-x-1">
                            <span class="text-3xl font-bold tracking-tight text-white group-hover:text-primary">Design and
                                Layout</span>
                        </p>
                        <p class="mt-4 text-sm leading-6 text-white">
                    ...
                    <div
                        ...
                        <p class="mt-6 flex items-baseline gap-x-1">
                            <span class="text-3xl font-bold tracking-tight text-white group-hover:text-primary">Equipment
                                Selection</span>
                        </p>
                        <p class="mb-16 mt-4 text-sm leading-6 text-white">
                    ...
                    <div
                        ...
                        <p class="mt-6 flex items-baseline gap-x-1">
                            <span class="text-3xl font-bold tracking-tight text-white group-hover:text-primary">Supplier
                                Procurement
                            </span>
                        </p>
                        <p class="mt-4 text-sm leading-6 text-white">
                    ...
                    <div
                        ...
                        <p class="mt-6 flex items-baseline gap-x-1">
                            <span class="text-3xl font-bold tracking-tight text-white group-hover:text-primary">Project
                                Management
                            </span>
                        </p>
                        <p class="mt-4 text-sm leading-6 text-white">
                    ...
                    <div
                        ...
                        <p class="mt-6 flex items-baseline gap-x-1">
                            <span class="text-3xl font-bold tracking-tight text-white group-hover:text-primary">Installation
                                and Testing
                            </span>
                        </p>
                        <p class="mb-20 mt-4 text-sm leading-6 text-white">
                    ...
                    <div
                        ...
                        <p class="mt-6 flex items-baseline gap-x-1">
                            <span class="text-3xl font-bold tracking-tight text-white group-hover:text-primary">Handover and
                                Documentation
                            </span>
                        </p>
                        <p class="mt-4 text-sm leading-6 text-white">
                    ...
                    <div
                        ...
                        <p class="mt-6 flex items-baseline gap-x-1">
                            <span class="text-3xl font-bold tracking-tight text-white group-hover:text-primary">Maintenance
                                Contracts
                            </span>
                        </p>
                        <p class="mt-4 text-sm leading-6 text-white">
                    ...
                    <div
                        ...
                        <p class="mt-6 flex items-baseline gap-x-1">
                            <span class="text-3xl font-bold tracking-tight text-white group-hover:text-primary">Customer
                                Satisfaction and Success
                            </span>
                        </p>
                        <p class="pb-16 mt-4 text-sm leading-6 text-white">
