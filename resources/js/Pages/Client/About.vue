            ...
            <main class="relative isolate">
                        ...
                        <div
                            ...
                            <div data-wow-duration="1.5s" data-wow-delay="1s" class="wow animate__lightSpeedInLeft">
                                <p>
                                    ...
                                    to suppliers who prioritize their own interests. <br> <br> Join us on this exciting
                                    journey as we
                ...
                <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
                    ...
                    <dl
                        ...
                        <div class="relative pl-9">
                            ...
                            <dd class="inline">Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus voluptas
                                blanditiis et.</dd>
                        </div>
                        <div class="relative pl-9">
                            <dt class="inline font-semibold text-white">
                            ...
                            <dd class="inline">Iure sed ab. Aperiam optio placeat dolor facere. Officiis pariatur eveniet
                                atque et dolor.</dd>
                        </div>
                        <div class="relative pl-9">
                            <dt class="inline font-semibold text-white">
                ...
                <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
                    <div class="mx-auto max-w-2xl lg:mx-0">
                        ...
                        <p class="mt-6 text-lg leading-8 text-black font-medium">Who we have work with</p>
                    </div>
                    <ul role="list"
                        ...
                        <li>
                            <img class="aspect-[14/13] w-full rounded-2xl object-cover"
                                src="https://trendtype.com/wp-content/uploads/2017/07/Java-House-logo.jpg" alt="">
                            <h3 class="mb-20 mt-6 text-lg font-semibold leading-8 tracking-tight text-white">Java</h3>
