            ...
            <main class="relative isolate">
                ...
                <div class="px-6 lg:px-8">
                    <div class="mx-auto max-w-2xl pt-20 text-center">
                        <h2 class="wow animate__rubberBand text-4xl font-bold tracking-tight text-white sm:text-6xl">Who We
                            Are</h2>
                ...
                <div class="mx-auto mt-20 max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
                        <div
                            class="grid max-w-xl grid-cols-1 gap-8 text-base leading-10 text-black font-bold lg:max-w-none lg:grid-cols-1">
